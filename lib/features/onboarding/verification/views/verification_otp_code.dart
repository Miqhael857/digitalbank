...
import 'package:digbank/features/onboarding/verification/views/verification_email_page.dart';
import 'package:digbank/features/onboarding/verification/views/widget/success_widget.dart';
    ...
    return OnboardingSkeletonWidget(
      ...
      onTap: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (c) => const VerificationEmailPage(),
          ),
        );
      },
      body: Scaffold(
