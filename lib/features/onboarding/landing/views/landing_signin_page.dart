...
class LandingSigninPage extends StatelessWidget {
  const LandingSigninPage({Key? key}) : super(key: key);
          ...
          SafeArea(
            child: Column(
              ...
              children: [
                const Spacer(flex: 1),
                const Padding(
                  padding: EdgeInsets.only(left: 152.0),
                  child: AppTextWidget(
                    text: 'Welcome to',
                    fontSize: 14,
                    color: whiteColor,
                ...
                const Padding(
                  ...
                  child: AppTextWidget(
                    text: 'Your ultimate goal saving and loan app',
                    fontSize: 14,
                    color: whiteColor,
                    alignment: Alignment.topLeft,
                  ),
